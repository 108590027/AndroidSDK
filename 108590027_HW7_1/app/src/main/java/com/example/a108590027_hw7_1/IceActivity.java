...
public class IceActivity extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu)
    {
        ...
        menu.add(0, menu2, 1, getString(R.string.act_donut));
        menu.add(0, menu3, 2, getString(R.string.act_froyo));
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        switch (item.getItemId())
        {
            case menu1: //main
                ...
                break;
            case menu2: //donut
                Intent intent2 = new Intent(this, DonutActivity.class);
                startActivity(intent2);
                break;
            case menu3: //froyo
                Intent intent3 = new Intent(this, FroyoActivity.class);
