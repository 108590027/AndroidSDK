...
public class MainActivity extends AppCompatActivity {
    ...
    private String mPrefFile = "com.example.android.scorekeeper";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Share Preference
        mShare = getSharedPreferences(mPrefFile, MODE_PRIVATE);

        //Find the TextViews by ID
        mScoreText1 = findViewById(R.id.score_1);
        mScoreText2 = findViewById(R.id.score_2);

        //Restores Share Preference
        mScore1 = mShare.getInt("score1", 0);
        mScore2 = mShare.getInt("score2", 0);
    ...
    protected void onPause() {
        ...
        SharedPreferences.Editor mEditor = mShare.edit();
        mEditor.putInt("score1", mScore1);
        mEditor.putInt("score2", mScore2);
        mEditor.apply();
    }
