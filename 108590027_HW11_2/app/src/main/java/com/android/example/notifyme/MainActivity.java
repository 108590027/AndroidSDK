...
public class MainActivity extends AppCompatActivity {
    ...
    public void updateNotification() {
        ...
        // method.
        NotificationCompat.Builder notifyBuilder = getNotificationBuilder();
        Intent learnIntent = new Intent(ACTION_UPDATE_NOTIFICATION);
        PendingIntent learnPendingIntent = PendingIntent.getBroadcast(this,
                NOTIFICATION_ID, learnIntent, PendingIntent.FLAG_ONE_SHOT);

        notifyBuilder.setContentTitle("Title 108590027").setStyle(new NotificationCompat.InboxStyle()
                .addLine(getString(R.string.inbox1))
                .addLine(getString(R.string.inbox2))
                .addLine(getString(R.string.inbox3))
                .setSummaryText("+2 more.")
        ).addAction(R.drawable.ic_infor, "Learn moreeee", learnPendingIntent);
